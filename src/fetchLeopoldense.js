...
const baseUrl = 'http://www.leopoldense.com.br';
...
const fetchLines = (opts = {}) => {
  ...
  .then((linesJson) => {
    ...
    green('write file : ./output/leopoldense-json.json');
    return writeFile('./output/leopoldense-json.json', JSON.stringify(linesJson), 'utf-8')
    .then(() => linesJson)
  })
  .catch(console.error)
